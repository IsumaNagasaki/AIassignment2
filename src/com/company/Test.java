...
public class Test extends JPanel {
        ...
        public void paint(Graphics g) {
            ...
            try{File input = new File("image1.jpg");
            image = ImageIO.read(input);
            width = image.getWidth();
            height = image.getHeight();}
            catch (Exception e){}
            ...
            try {
                for (int i = 0; i < height; i++) {
                    ...
                    for (int j = 0; j < width; j++) {
                        ...
                        if (new_red>255){new_red=255;} if(new_red<0) {new_red=0;}
                        int new_green =  (green+green_plus);
                        if (new_green>255){new_green=255;} if(new_green<0) {new_green=0;}
                        int new_blue = (blue+blue_plus);
                        if (new_blue>255){new_blue=255;} if(new_blue<0) {new_blue=0;}
        ...
        private Gene[] BigColoursImage (ArrayList<Color> BaseColors, int size){
            ...
            for (int i=0; i<chromosomes.length; i++){
                ...
                if (i==0){
                    x1=0; y1=0; x2=width/6; y2=0; x3=0; y3=height/6; x4=width/6; y4 = height/6;
                    randomIndex = 1+rand.nextInt(BaseColors.size()-1);
                    alpha = 200+rand.nextInt(55);
                }else
                if (i==1){
                    x1=width/6; y1=0; x2=width/3-1; y2=0; x3=width/6; y3=height/6; x4=width/3-1; y4 = height/6;
                    randomIndex = 1+rand.nextInt(BaseColors.size()-1);
                    alpha = 200+rand.nextInt(55);
                }else
                if (i==2){
                    x1=0; y1=height/6; x2=width/6; y2=height/6; x3=0; y3=height/3-1; x4=width/6; y4 = height/3-1;
                    randomIndex = 1+rand.nextInt(BaseColors.size()-1);
                    alpha = 200+rand.nextInt(55);
                }else
                if (i==3){
                    x1=width/6; y1=height/6; x2=width/3-1; y2=height/6; x3=width/6; y3=height/3-1; x4=width/3; y4 = height/3-1;
                    randomIndex = 1+rand.nextInt(BaseColors.size()-1);
                    alpha = 200+rand.nextInt(55);
                }else
                    if(i<chromosomes.length/4){
        ...
        private Compliance[] Crossover (Compliance parent1, Compliance parent2, BufferedImage orig, ArrayList<Color>BaseColors){
            ...
            for (int i =0; i<parent1.chromosome.length; i++){
                ...
                else {children[0].chromosome[i]=parent2.chromosome[i];
        ...
        private Compliance Mutation (Compliance orig, ArrayList<Color> BaseColors, BufferedImage original){
            ...
            if(index>3){
                if(index<orig.chromosome.length/4){
                    ...
                    switch (coordinate){
                        case 0: x2=rand.nextInt(width/3-1); break;
                        case 1: y2=rand.nextInt(height/3-y4); break;
                        case 2: x3=rand.nextInt(width/3-x4); break;
                        case 3: y3=rand.nextInt(height/3-1); break;
                        case 4: x4=x3+rand.nextInt(width/3-x3); break;
                        case 5: y4=y2+rand.nextInt(height/3-y2); break;
                        default: break;
                    }
                }
                    ...
                    int coordinate = rand.nextInt(8);
                    switch (coordinate){
                        case 0: x1=rand.nextInt(width/3-1); break;
                        case 1: y1=rand.nextInt(height/3-1); break;
                        case 2: x3=rand.nextInt(width/3-x4); break;
                        case 3: y3=y1+rand.nextInt(height/3-y1); break;
                        case 4: x4=x3+rand.nextInt(width/3-x3); break;
                        case 5: y4=rand.nextInt(height/3); break;
                        default: break;
                    }
                    ...
                    switch (coordinate){
                        case 0: x2=rand.nextInt(width/3-1); break;
                        case 1: y2=rand.nextInt(height/3-y4); break;
                        case 2: x1=rand.nextInt(width/3-x2); break;
                        case 3: y1=rand.nextInt(height/3-1); break;
                        case 4: x4=rand.nextInt(width/3); break;
                        case 5: y4=y2+rand.nextInt(height/3-y2); break;
                        default: break;
                    }
                }
                    ...
                    int coordinate = rand.nextInt(8);
                    switch (coordinate){
                        case 0: x2=x1+rand.nextInt(width/3-x1); break;
                        case 1: y2=rand.nextInt(height/3-1); break;
                        case 2: x3=rand.nextInt(width/3-1); break;
                        case 3: y3=y1+rand.nextInt(height/3-y1); break;
                        case 4: x1=rand.nextInt(width/3-x2); break;
                        case 5: y1=rand.nextInt(height/3-y3); break;
                        default: break;
                    }
            ...
            Color color = new Color(buff.getRed(), buff.getGreen(), buff.getBlue(), alpha);
            orig.chromosome[index]=new Gene(color, x1, y1, x2, y2, x3, y3, x4, y4);
            orig.fitness=Fitness(original, orig.chromosome, BaseColors);
            return orig;
        }
        ...
        private Compliance[] Selection (Compliance[] population, BufferedImage orig, ArrayList<Color> BaseColors){
            ...
            for (int i=0; i<population.length; i+=4) {
                ...
                Compliance[] new_selection = {population[i], population[i + 1], population[i + 2], population[i + 3], Children[0], Children[1], Mutant1, Mutant2};
                Compliance[] Sorted2 = Sorter(new_selection);
                new_population[i] = Sorted2[0];
